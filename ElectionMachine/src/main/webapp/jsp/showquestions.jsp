...
<c:forEach var="kysymykset" items="${requestScope.questionlist }">
	<li>${kysymykset} <a href='http://localhost:8080/rest/electionservice/delete/${kysymykset.kysymys_id}' onclick="return window.confirm('Haluatko varmasti poistaa?');">Poista</a></a> <a href='/rest/electionservice/readtoupdatequestion/${kysymykset.kysymys_id}'>Muokkaa</a>
</c:forEach>
</section>
